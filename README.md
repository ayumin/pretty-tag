...
**インストール URL：**
```
https://login.salesforce.com/packaging/installPackage.apexp?p0=04tQ80000003PGPIA2
```

**CLI：**
```bash
sf package install --package 04tQ80000003PGPIA2 --target-org <org-alias> --wait 10
```
